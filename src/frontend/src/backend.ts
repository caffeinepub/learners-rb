...
export class Backend implements backendInterface {
    ...
    async addChapter(arg0: Chapter): Promise<bigint> {
        if (this.processError) {
            try {
    ...
    async addClass(arg0: Class): Promise<bigint> {
        if (this.processError) {
            try {
    ...
    async addSubject(arg0: Subject): Promise<bigint> {
        if (this.processError) {
            try {
    ...
    async getLessonsByChapter(arg0: bigint): Promise<Array<Lesson>> {
        if (this.processError) {
            try {
                const result = await this.actor.getLessonsByChapter(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async updateClass(arg0: bigint, arg1: Class): Promise<void> {
        if (this.processError) {
            try {
    ...
    async updateLesson(arg0: bigint, arg1: Lesson): Promise<void> {
        if (this.processError) {
            try {
    ...
    async updateSubject(arg0: bigint, arg1: Subject): Promise<void> {
        if (this.processError) {
            try {
